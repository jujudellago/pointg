<?php
$current_addon_data = auto_robot_get_addon_data('flickr');
?>
<div class="robot-box" role="document">
    ...
    <div class="robot-box-header robot-block-content-center">
        ...
        <div class="robot-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(AUTO_ROBOT_URL.'/assets/images/flickr.png'); ?>" alt="<?php esc_attr_e( 'Flickr API', Auto_Robot::DOMAIN ); ?>">

        </div>

        <div class="robot-box-content integration-header">

            <h3 class="robot-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup Flickr API', Auto_Robot::DOMAIN ); ?></h3>

			<span class="robot-description">
                <?php esc_html_e( 'Setup Flickr API to be used by Auto Robot to display tweets on your blog.', Auto_Robot::DOMAIN ); ?>
			</span>
