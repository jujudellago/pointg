<?php
$current_addon_data = auto_robot_get_addon_data('open-ai');
?>
<div class="robot-box" role="document">
    ...
    <div class="robot-box-header robot-block-content-center">
        ...
        <div class="robot-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(AUTO_ROBOT_URL.'/assets/images/open-ai.png'); ?>" alt="<?php esc_attr_e( 'Open AI API Key', Auto_Robot::DOMAIN ); ?>">

        </div>

        <div class="robot-box-content integration-header">

            <h3 class="robot-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup Open AI API Key', Auto_Robot::DOMAIN ); ?></h3>

			<span class="robot-description">
                <?php esc_html_e( 'Setup Open AI API Key to generate AI content automatically for your website and blog.', Auto_Robot::DOMAIN ); ?>
			</span>
        ...
        <form class="robot-integration-form" method="post" name="robot-integration-form" action="">
            ...
            <div class="robot-border-frame robot-description">
                ...
                <span>
                    <?php
                    printf(
                        esc_html__( 'Follow %1$s your Open AI API Key.', Auto_Robot::DOMAIN ),
                        '<a href="https://wpautorobot.com/document/api-settings/">these instructions to retrieve</a>'
                    );
                    ?>
                </span>
