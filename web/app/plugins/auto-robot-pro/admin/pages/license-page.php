...
if ( ! class_exists( 'Auto_Robot_License_Page' ) ) :

	class Auto_Robot_License_Page extends Auto_Robot_Admin_Page {
		/**
        ...
        public function enqueue_scripts( $hook ) {
        	...
        	// Load admin scripts
        	auto_robot_admin_enqueue_scripts_license(
            	AUTO_ROBOT_VERSION,
